window.translations = {
  en: {
    ...
    contact: {
      title: "Contact Us",
      intro: "Let’s discuss how Hybrionix can secure your IT infrastructure.",
      name: "Your Name",
      email: "Your Email",
    ...
    index: {
      ...
      hero_p: "Hybrionix empowers organizations with robust, sovereign IT infrastructure solutions, fully hosted and managed within Europe. We combine cloud flexibility with on-premises control for maximum security and compliance.",
      callout_heading: "Need secure infrastructure?",
      ...
      why: [
        ...
        "Zero-trust security architecture and 24/7 monitoring",
        "Expert support from certified European engineers",
        "Custom infrastructure design for regulated industries"
      ]
    },
    services: {
      title: "Our Services",
      intro: "Secure, scalable, and compliant IT infrastructure for European organizations.",
      list: [
        "<strong>Hybrid Cloud Solutions:</strong> Seamlessly integrate public and private clouds with on-premises infrastructure, all within European borders.",
        "<strong>Managed Hosting:</strong> Dedicated and virtual servers in ISO 27001-certified European data centers.",
        "<strong>Network Security:</strong> Firewalls, VPNs, and zero-trust access tailored for compliance and resilience.",
        "<strong>Disaster Recovery & Backup:</strong> Encrypted, geo-redundant backups and rapid recovery plans.",
        "<strong>Compliance Consulting:</strong> GDPR, NIS2, and industry-specific regulatory guidance.",
        "<strong>24/7 Monitoring & Support:</strong> Proactive monitoring and rapid incident response by European experts."
      ],
  ...
  nl: {
    ...
    contact: {
      ...
      intro: "Laten we bespreken hoe Hybrionix uw IT-infrastructuur kan beveiligen.",
      name: "Uw naam",
    ...
    index: {
      ...
      hero_p: "Hybrionix biedt organisaties robuuste, soevereine IT-infrastructuuroplossingen, volledig gehost en beheerd binnen Europa. Wij combineren cloudflexibiliteit met on-premises controle voor maximale veiligheid en compliance.",
      callout_heading: "Op zoek naar veilige infrastructuur?",
      ...
      why: [
        ...
        "Zero-trust beveiligingsarchitectuur en 24/7 monitoring",
        "Expertondersteuning door gecertificeerde Europese engineers",
        "Maatwerk infrastructuurontwerp voor gereguleerde sectoren"
      ]
    },
    services: {
      title: "Onze Diensten",
      intro: "Veilige, schaalbare en conforme IT-infrastructuur voor Europese organisaties.",
      list: [
        "<strong>Hybride Cloudoplossingen:</strong> Integreer publieke en private clouds naadloos met on-premises infrastructuur, allemaal binnen Europa.",
        "<strong>Managed Hosting:</strong> Dedicated en virtuele servers in ISO 27001-gecertificeerde Europese datacenters.",
        "<strong>Netwerkbeveiliging:</strong> Firewalls, VPN's en zero-trust toegang op maat voor compliance en veerkracht.",
        "<strong>Disaster Recovery & Backup:</strong> Versleutelde, geografisch redundante back-ups en snelle herstelplannen.",
        "<strong>Compliance Consulting:</strong> AVG, NIS2 en sectorspecifieke regelgeving.",
        "<strong>24/7 Monitoring & Support:</strong> Proactieve monitoring en snelle incidentrespons door Europese experts."
      ],
  ...
  de: {
    ...
    index: {
      ...
      hero_p: "Hybrionix bietet Organisationen robuste, souveräne IT-Infrastrukturlösungen, vollständig gehostet und verwaltet in Europa. Wir kombinieren Cloud-Flexibilität mit On-Premises-Kontrolle für maximale Sicherheit und Compliance.",
      callout_heading: "Benötigen Sie sichere Infrastruktur?",
      ...
      why: [
        ...
        "Zero-Trust-Sicherheitsarchitektur und 24/7-Überwachung",
        "Expertenunterstützung durch zertifizierte europäische Ingenieure",
        "Individuelle Infrastruktur für regulierte Branchen"
      ]
    },
    services: {
